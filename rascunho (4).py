...
def listarTodosMed(matrizMedicos,matrizPacientes,opcaoSubmenu):
    continuar=True
    while continuar:
        if opcaoSubmenu == 1:
...
def listarElementoMed(matrizMedicos,matrizPacientes,opcaoSubmenu):
    continuar=True
    while continuar:
        if opcaoSubmenu==1:
...
def incluirMed(matrizMedicos,matrizPacientes,opcaoSubmenu):
    continuar=True
    while continuar:
        if opcaoSubmenu==1:
            novo_med=[]
...
def alterarMed(matrizMedicos,matrizPacientes,opcaoSubmenu):
    continuar=True
    while continuar:
        if opcaoSubmenu==1:
            for i in range(len(matrizMedicos)):
...
def excluirMed(matrizMedicos,matrizPacientes,opcaoSubmenu):
    continuar=True
    while continuar:
        if opcaoSubmenu==1:
            for i in range(len(matrizMedicos)):
...
def submenu(matrizMedicos,matrizPacientes,opcaoSubmenu):
    ...
    if operacao == 1:
        listarTodosMed(matrizMedicos,matrizPacientes,opcaoSubmenu)
    elif operacao == 2:
        listarElementoMed(matrizMedicos,matrizPacientes,opcaoSubmenu)
    elif operacao == 3:
        incluirMed(matrizMedicos,matrizPacientes,opcaoSubmenu)
    elif operacao == 4:
        alterarMed(matrizMedicos,matrizPacientes,opcaoSubmenu)
    elif operacao == 5:
        excluirMed(matrizMedicos,matrizPacientes,opcaoSubmenu)
    elif operacao == 6:
